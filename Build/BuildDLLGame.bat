...
g++ -std=gnu++11 -IHeaders/ -ILocal/Sources/ Local/Bins/Runner.o Local/Bins/ResourceManager.o Local/Bins/AttackDecision.o -Wl,--whole-archive lib/Engine.a -Wl,--no-whole-archive -shared -o lib/Bots.dll -O9  -lPsapi -lgdi32 -luser32